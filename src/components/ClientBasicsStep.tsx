...
export function ClientBasicsStep({ bookingData, updateBookingData }: ClientBasicsStepProps) {
  return (
        ...
        <CardContent className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              <Label htmlFor="clientName" className="text-black-elegant">Full Name *</Label>
              <Input
                id="clientName"
            ...
            <div className="space-y-2">
              <Label htmlFor="phone" className="text-black-elegant">Phone *</Label>
              <Input
                id="phone"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              <Label htmlFor="whatsapp" className="text-black-elegant">WhatsApp</Label>
              <Input
                id="whatsapp"
            ...
            <div className="space-y-2">
              <Label htmlFor="email" className="text-black-elegant">Email *</Label>
              <Input
                id="email"
                type="email"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              <Label htmlFor="homeAddress" className="text-black-elegant">Home Address</Label>
              <Input
                id="homeAddress"
            ...
            <div className="space-y-2">
              <Label htmlFor="currentLocation" className="text-black-elegant">Current Location</Label>
              <Input
                id="currentLocation"
                value={bookingData.currentLocation}
                onChange={(e) => updateBookingData({ currentLocation: e.target.value })}
        ...
        <CardContent className="space-y-6">
          <div className="space-y-2">
            ...
            <Select 
              ...
              onValueChange={(value: 'bride' | 'groom' | 'combined' | 'other') => 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              <Label htmlFor="eventLocation" className="text-black-elegant">Event Location</Label>
              <Input
                id="eventLocation"
            ...
            <div className="space-y-2">
              <Label htmlFor="eventDate" className="text-black-elegant">Event Date</Label>
              <Input
                id="eventDate"
                type="date"
          ...
          <div className="p-4 bg-pastel-green/30 rounded-lg border border-gray-200">
            <p className="text-sm text-black-elegant/80">
              <strong>Note:</strong> Guest range and budget details will be configured in the next step for more accurate package recommendations.
            </p>
          </div>
        </CardContent>
      </Card>
